...
public class TestZipTriDistance {
...
//        System.out.println( "Sr4: " + sr6.toString() );
    ...
    public void testdistance1() {
        assertEquals(SparseRep.sparseTriDistance(doubles1,doubles2), SparseRep.zipTriDistance(sr1,sr2), 0.0001d);
    }

    @Test
    public void testdistance0() {
        assertEquals(SparseRep.sparseTriDistance(doubles2,zeros1), SparseRep.zipTriDistance(sr2,sr3), 0.0001d);
    }

    @Test
    public void testdistance3() {
        assertEquals(SparseRep.sparseTriDistance(doubles5,doubles6), SparseRep.zipTriDistance(sr5,sr6), 0.0001d);
    }

    @Test
    public void testdistance4() {
        assertEquals(SparseRep.sparseTriDistance(doubles7,doubles8), SparseRep.zipTriDistance(sr7,sr8), 0.0001d);
    }

    @Test public void testdistanceDiffLengths1() {
        assertEquals(SparseRep.sparseTriDistance(doubles9,doubles10), SparseRep.zipTriDistance(sr9,sr10), 0.0001d);
    }

    @Test public void testdistanceDiffLengths2() {
        assertEquals(SparseRep.sparseTriDistance(doubles10,doubles9), SparseRep.zipTriDistance(sr10,sr9), 0.0001d);
    }
}
